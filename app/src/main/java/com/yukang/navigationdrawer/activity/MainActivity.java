package com.yukang.navigationdrawer.activity;
...
import com.yukang.navigationdrawer.R;
import com.yukang.navigationdrawer.fragment.HomeFragment;
import com.yukang.navigationdrawer.fragment.MoviesFragment;
import com.yukang.navigationdrawer.fragment.NotificationsFragment;
import com.yukang.navigationdrawer.fragment.PhotosFragment;
import com.yukang.navigationdrawer.fragment.SettingsFragment;
import com.yukang.navigationdrawer.other.CircleTransform;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String urlProfileImg = "http://i1.piimg.com/520292/599c5de3eb6dac43.jpg";
    ...
    private boolean shouldLoadHomeFragBackPress = true;
    ...
    private void loadHomeFragment() {
        ...
        if (mPendingRunable != null) mHandler.post(mPendingRunable);
    ...
    private void setUpNavigationView() {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                // Checking if the item in checked state of not, if not make it in checked state
                if (item.isChecked())
    ...
    public void onBackPressed() {
        ...
        if (shouldLoadHomeFragBackPress) {
            // checking if usr is on other navigation menu
            // rather than home
            if (navItemIndex != 0) {
                navItemIndex = 0;
                CURRENT_TAG = TAG_HOME;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the acton bar if it is present.

        // show menu only when home fragment is selected
        if (navItemIndex == 0) getMenuInflater().inflate(R.menu.main, menu);

        // when fragment is notifications, load the menu created for notifications
        if (navItemIndex == 3) getMenuInflater().inflate(R.menu.notifications, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // user is in notifications frament
